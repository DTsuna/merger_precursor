...
# model parameters (solar metallicity)
X_H = 0.0 # hydrogen mass fraction
use_tab_opac = True # use opacity table. only supports X_H=0. if false, use Kramers for absorption opacity.
